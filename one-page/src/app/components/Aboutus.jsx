    ...
    <main>
      <section className='h-screen p-10 flex bg-gray-700 items-center justify-center mt-36'>
        ...
        <div className='w-1/2 items-center flex flex-col justify-center p-8'>
          ...
          <p className='text-gray-300 mt-8 text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto quae reprehenderit veritatis? Harum, ut dolorem vero quos iusto id ipsum at rerum veniam? Earum modi magni minima eius officiis voluptatum.</p>
